/*
Title: Catalog
Description: Catalog items Grammars & Formats, dynamic filtering and template rendering.
*/
let catalogItems = [];
...
function initVueApp() {
    const CatalogList = {
        ...
        watch: {
            // Watch route query changes and sync sortBy & page accordingly
            ...
            '$route.query': {
                ...
                handler(newQuery, oldQuery) {
                    // Reset page to 1 if filters or sortBy changed (except page itself)
        ...
        computed: {
            page: {
                ...
                set(value) {
                    this.$router.push({ path: '/catalog', query: { ...this.$route.query, page: value } });
                }
            },
            filteredTests() {
                ...
                switch (this.sortBy) {
                    ...
                    case 'code':
                        return sorted.sort((a, b) => {
                            const aCodes = getFirstCode(a);
                            const bCodes = getFirstCode(b);
    ...
    const CatalogDetailTemplateRender = {
        template: `
            <main v-if="test">
                ...
                <form class="filter-menu--detailed-search" @submit.prevent @reset.prevent="clearFilters">
                    ...
                    <div class="filter-group">
                        ...
                        <div>
                            ...
                            <input id="compliant-code" type="text" v-model="code" placeholder="" />
                        </div>

                        <div>
                            <label for="search">Search by Title</label>
                            <input id="search" type="text" v-model="search" placeholder="" />
                        </div>
                    </div>
