...
@Suite("SimpleRegex Tests") struct SimpleRegexTests {
	...
	func test_SimpleRegex_empty_union_empty() async throws {
	...
	func test_SimpleRegex_empty_union_epsilon() async throws {
	...
	func test_SimpleRegex_empty_union_symbol() async throws {
	...
	func test_SimpleRegex_empty_concatenate_empty() async throws {
	...
	func test_SimpleRegex_empty_concatenate_epsilon() async throws {
	...
	func test_SimpleRegex_empty_concatenate_symbol() async throws {
	...
	@Test("empty.star")
	func test_SimpleRegex_empty_star() async throws {
	...
	func test_SimpleRegex_epsilon_union_empty() async throws {
	...
	func test_SimpleRegex_epsilon_union_epsilon() async throws {
	...
	func test_SimpleRegex_epsilon_union_symbol() async throws {
	...
	func test_SimpleRegex_epsilon_concatenate_empty() async throws {
	...
	func test_SimpleRegex_epsilon_concatenate_epsilon() async throws {
	...
	func test_SimpleRegex_epsilon_concatenate_symbol() async throws {
	...
	@Test("epsilon.star")
	func test_SimpleRegex_epsilon_star() async throws {
	...
	func test_SimpleRegex_union_nested() async throws {
	...
	@Test("union.star")
	func test_SimpleRegex_union_star() async throws {
	...
	func test_SimpleRegex_concatenate_star() async throws {
		let seq = SimpleRegex<UInt8>.epsilon.star()
		// epsilon* == epsilon
	...
	@Test("epsilon.star")
	func test_SimpleRegex_symbol_star() async throws {
