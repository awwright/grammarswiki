...
public struct REDialactCollection {
	...
	public static var builtins = REDialactCollection.init(
		...
		Constructor(
			...
			label: "ECMAScript RegExp Literal",
			language: "ECMAScript",
			engine: "ECMAScript",
			reference: "https://tc39.es/ecma262/#sec-regexp-regular-expression-objects",
			description: { REDialectBuiltins.ecmascriptLiteral.encode($0) },
			findMatchCode: { REDialectBuiltins.ecmascriptLiteral.encodeFind($0) },
			lineMatchCode: { REDialectBuiltins.ecmascriptLiteral.encodeLine($0) },
			wholeMatchCode: { REDialectBuiltins.ecmascriptLiteral.encodeWhole($0) },
		),
		Constructor(
			id: "ecmascript,string",
			label: "ECMAScript RegExp Object",
			language: "ECMAScript",
			engine: "ECMAScript",
			reference: "https://tc39.es/ecma262/#sec-regexp-regular-expression-objects",
			description: { REDialectBuiltins.ecmascriptString.encode($0) },
			findMatchCode: { "RegExp('\(REDialectBuiltins.ecmascriptString.encodeFind($0))', '')" },
			lineMatchCode: { "RegExp('\(REDialectBuiltins.ecmascriptString.encodeLine($0))', '')" },
			wholeMatchCode: { "RegExp('\(REDialectBuiltins.ecmascriptString.encodeWhole($0))', '')" },
		),
		Constructor(
			id: "posixe",
