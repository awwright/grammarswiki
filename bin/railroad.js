...
// This function modification by Austin Wright:
async function main() {
	...
	let Diagram = funcs.Diagram;
	let ComplexDiagram = funcs.ComplexDiagram;
	let Sequence = funcs.Sequence;
	let Stack = funcs.Stack;
	let OptionalSequence = funcs.OptionalSequence;
	let AlternatingSequence = funcs.AlternatingSequence;
	let Choice = funcs.Choice;
	let HorizontalChoice = funcs.HorizontalChoice;
	let MultipleChoice = funcs.MultipleChoice;
	let Optional = funcs.Optional;
	let OneOrMore = funcs.OneOrMore;
	let ZeroOrMore = funcs.ZeroOrMore;
	let Group = funcs.Group;
	let Start = funcs.Start;
	let End = funcs.End;
	let Terminal = funcs.Terminal;
	let NonTerminal = funcs.NonTerminal;
	let Comment = funcs.Comment;
	let Skip = funcs.Skip;
